/**
 * Script de migração: cria as tabelas para o módulo de salários (Fase 1).
 * Rodar UMA VEZ antes de implementar as rotas.
 * Uso: node scripts/criar-tabelas-salarios.js
 */
...
async function criar() {
  // Tabela para pagamentos mensais de salário
  await pool.query(`
  ...
  // Tabela para custos extras de pessoal
  await pool.query(`
