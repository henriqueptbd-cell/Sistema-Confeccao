# Sistema de Confecção de Roupas Personalizadas

## 📌 Sobre o Projeto

Este repositório contém a documentação e estrutura inicial de um sistema para gestão de pedidos de confecção de roupas personalizadas.
...
**visao-produto.md**
Contém a visão geral do produto, incluindo problema, público-alvo e objetivos do sistema.

**levantamento-requisitos.md**
Documento com os requisitos funcionais e não funcionais do sistema.
...
Este repositório **não contém dados reais da empresa**, apenas representações simplificadas do processo de pedidos.

---

## ⚠️ Uso Acadêmico

Este projeto foi desenvolvido como parte de estudos na área de **desenvolvimento de software e análise de sistemas**.
...
Projeto em fase inicial de documentação e estruturação.
...
Henrique Camargo
Projeto acadêmico de estudo em desenvolvimento de software.
